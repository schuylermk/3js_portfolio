...
const FeedbackCard = ({
  ...
  >
    <p className="text-white leading-none font-black text-[48px]">"</p>

    <p className="text-white tracking-wider text-[18px]">{testimonial}</p>
    <p className="text-white font-black text-right text-[48px]">"</p>
    <div className="mt-7 flex justify-between items-center gap-1">
      <div className="flex-1 flex flex-col">
        <p className="text-white font-medium text-[16-px]">
